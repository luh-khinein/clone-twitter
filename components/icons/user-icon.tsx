...
export const UserIconDisabled: React.FC<Props> = ({ color, width, height }) => {
  return (
    <svg
      viewBox='0 0 24 24'
...
export const UserIconActived: React.FC<Props> = ({ color, width, height }) => {
  return (
    <svg
      viewBox='0 0 24 24'
      width={width ? width : 20}
...
export const AddUserIcon: React.FC<Props> = ({ color, width, height }) => {
  return (

...
export const HomeIconDisabled: React.FC<Props> = ({ color }) => {
  return (
    <svg viewBox='0 0 24 24' className='w-icon h-icon flex items-center justify-center' fill={color}>
      <g>
        <path
...
export const HomeIconActived: React.FC<Props> = ({ color }) => {
  return (
